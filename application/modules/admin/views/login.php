...
<body class="h-100">
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                  ...
                                  <form form action="<?php echo BASE_URL.'admin/check_login'; ?>" method="post" name="login_form" id="login_form">
                                    <?php
                                        if($this->session->userdata('change_arr'))
                                        {
                                            echo $this->session->userdata('change_arr');
                                            $this->session->unset_userdata('change_arr');
                                        }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                          ...
                                          <div class="form-group">
                                              <a class="text-white" href="<?php echo base_url(); ?>admin/forgot-password">Forgot Password?</a>
                                          </div>
                                        </div>
    ...
    ***********************************-->
    ...
    <script src="<?php echo ADMIN_CUSTOM_JS; ?>login.js"></script>
